        ...
        <b-tabs content-class="mt-2" fill>
          <b-tab active>
            ...
            <b-card no-body style="height:70%;">
              ...
              <b-card-body v-if="CurrentBondData" style="overflow: scroll; height:1047px; padding:2px">
          ...
          <b-tab>
            ...
            <b-card no-body style="height:70%;">
              ...
              <b-card-body v-if="CurrentBondData" style="overflow: scroll; height: 747px; padding:2px">
