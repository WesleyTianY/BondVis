  ...
  <div>
    <div id="loading" v-if="isLoading">
      ...
      <div class="display">
        ...
        <div class="display__svg_time"></div>
      </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    render() {
      ...
      const svg = select(".display__svg_time").select("svg");
      if (svg.empty()) {
        select(".display__svg_time").append('svg');
      }

      Treemap(select(".display__svg_time svg"), {
        data: this.data,
        height,
        width,
        margin,
      ...
      // colorLegends(select(".display__svg_time"), {
      //   data: this.data,
      //   innerHeight,
      //   innerWidth,
      //   margin,
