<template>
  <div>
    <b-card no-body style="height: 800px;">
      <div>
        <b-tabs content-class="mt-2" fill>
          <b-tab active >
            <template #title>
              <span style="font-size: 15px; height: 820px;">Statistic</span>
            </template>
            <!-- <div class="mt-3">
            ...
            <b-card no-body >
              ...
              <b-card-body v-if="CurrentBondData" style="overflow: scroll; height: 750px; padding:2px">
          ...
          <b-tab>
            ...
            <b-card no-body style="height:70%;">
              <div v-if="CurrentBondData" style="overflow: scroll; height: 750px; padding:2px" class="accordion" role="tablist">
                <!-- <b-card
